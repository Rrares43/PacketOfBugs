...
public class VoteCommand implements PostActionCommand {
    ...
    public VoteCommand(PostClient postClient, IntReader intReader, OutputWriter output, boolean isUpvote) {
    ...
    public void execute(int postId) {
        ...
        try {
            ...
            if (isUpvote) {
                resultMessage = postClient.upvote(postId, choice);
            } else {
                resultMessage = postClient.downvote(postId, choice);
            }
